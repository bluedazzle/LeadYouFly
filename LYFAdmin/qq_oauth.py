...
class APIClient(object):
    ...
    def get_access_token(self, endpoint, **kwargs):
        ...
        self.set_access_token(access_token.access_token, access_token.expires_in)
        return access_token
    ...
    def get_user_info(self):
        ...
        if not self.openid or not self.access_token:
            raise QQBaseException('get openid and access_token before use this method')
        ret = _http_get('https://graph.qq.com/user/get_user_info',
